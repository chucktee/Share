...
static CTDatabase *database = nil;
static NSMutableDictionary *tableCache = nil;

@implementation CTDatabaseModel
...
{
	NSAssert1(database, @"Database not set. Set the database using [CTDatabaseModel setDatabase] before using ActiveRecord.", @"");
}
